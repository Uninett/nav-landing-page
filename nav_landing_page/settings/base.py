...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "releases.context_processors.latest_stable_release",
    )
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'appstatic')
...
# Load additional settings modules, and decide if prod or local
PROD = False
SETTINGS_MODULES = ['local']

if PROD:
    SETTINGS_MODULES = ['prod']

for settings_module in SETTINGS_MODULES:
    if not os.path.exists(os.path.join(SETTINGS_DIR,
            settings_module + ".py")):
